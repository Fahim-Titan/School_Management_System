...
@section('content')
    ...
    <!--<img src="{{ URL::to('src/image/slider/2.jpg')}}" alt="img" width="100%" height="800px">
	...
	<figure class="slider">
		<figure>
			<img class="img-responsive" src="src/image/slider/2.jpg" alt>
      <div class="slider_caption">
        <h2>Largest & Beautiful University</h2>
        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
        <!--<a class="slider_btn" href="#">Know More</a>-->
		...
		<figure>
			<img class="img-responsive" src="src/image/slider/3.jpg" alt>
      <div class="slider_caption slider_right_caption">
		...
		<figure>
			<img class="img-responsive" src="src/image/slider/4.jpg" alt>
      <div class="slider_caption">
